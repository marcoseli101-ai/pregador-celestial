    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/80 backdrop-blur-xl">
      <div className="container flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link to="/login">
            <Button size="sm" className="hidden sm:flex bg-gradient-gold text-background hover:opacity-90">
              Cadastrar
            </Button>
          </Link>
          <Button
        ...
        <div className="border-t border-border bg-background p-4 lg:hidden">
          <nav className="flex flex-col gap-1">
            ...
            <div className="mt-3 flex gap-2">
              ...
              <Link to="/login" className="flex-1" onClick={() => setMobileOpen(false)}>
                <Button className="w-full bg-gradient-gold text-background">Cadastrar</Button>
              </Link>
            </div>
